...
extern void hedera_transaction__crypto_create__set_proxy_account(HederaTransaction*, HederaAccountId id);
...
extern void hedera_transaction__crypto_create__set_receive_record_threshold(HederaTransaction*, int64_t threshold);

extern void hedera_transaction__crypto_create__set_receiver_signature_required(HederaTransaction*, bool required);
