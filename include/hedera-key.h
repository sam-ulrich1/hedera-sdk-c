...
/// Returns [HEDERA_ERROR_SUCCESS] (0) on success or any other value on error. Use [hedera_error_message] to retrieve
/// a message for the error.
extern HederaError hedera_secret_key_sign(HederaSecretKey*, const void* message, size_t message_len, HederaSignature* out);
...
extern int8_t hedera_public_key_verify(HederaPublicKey* p, HederaSignature* s, const void* message, size_t message_len);
